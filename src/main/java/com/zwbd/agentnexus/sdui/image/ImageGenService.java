...
import com.zwbd.agentnexus.sdui.image.dto.Txt2ImgRequest;
...
public class ImageGenService {
    ...
    public void init() {
        ...
        // Set a long timeout for image generation (large images can take minutes)
     ...
     * @param width           image width (multiple of 64)
     * @param height          image height (multiple of 64)
     * @param steps           sampling steps (8-12 draft, 20-30 quality)
     * @param cfgScale        classifier-free guidance scale
     * @param seed            random seed (-1 for random)
     * @param samplerName     sampler name (null = use DrawThings UI setting)
     * @param count           number of images to generate
     * @return response with base64 data and saved file URLs
     */
    ...
    /**
     * Get the current DrawThings state (model, sampler, settings).
     */
    ...
    /**
     * Quick health check — pings the DrawThings root endpoint.
     */
    ...
    private Txt2ImgResponse callDrawThingsApi(Txt2ImgRequest request) {
        ...
        // Decode each base64 image → save as PNG → collect URLs
        ...
        for (int i = 0; i < base64Images.size(); i++) {
            ...
            try {
                ...
                String imageUrl = "/api/v1/sdui/image/view/" + filename;
