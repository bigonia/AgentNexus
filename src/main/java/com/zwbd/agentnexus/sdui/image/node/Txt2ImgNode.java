package com.zwbd.agentnexus.sdui.image.node;

import com.zwbd.agentnexus.sdui.image.ImageGenService;
...
/**
 * SDUI workflow node for text-to-image generation via local DrawThings.
 * <p>
...
public class Txt2ImgNode implements CapabilityNode {
    ...
    public NodeSchema schema() {
        return new NodeSchema(
                ...
                false, 120000  // not suspendable, 2-minute timeout
        );
    }
